CLASS zcl_gen_data_fmb DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
*    DELETE FROM zrap100_dtrav###.
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZATRAV_{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
